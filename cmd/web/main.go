...
func main() {
	...
	fmt.Print("Starting mail listener...")
	listenForMail()
...
func run() (*driver.DB, error) {
	...
	// read flags
	inProduction := flag.Bool("production", true, "Applications is in production")
	...
	dbSSL := flag.String("dbssl", "disable", "Databasek ssl settings (disable, prefer, require)")
